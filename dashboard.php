...
<li class="sidebar-header">Process Managment</li>
       <li class="has-sub"> 
		...
		<div class="container-fluid ">
								...
								<div class="col-lg-12 px-2">
									<div class="submenu-box"> 
										<ul class="list-unstyled m-0">
											<li><a href="pages/ordermanager.php?id=1">Pending Orders</a></li>
                      <li><a href="pages/ordermanager.php?id=2">Confirm Orders</a></li>
                      <li><a href="pages/ordermanager.php?id=3">Deliverd Orders</a></li>
                      <li><a href="pages/ordermanager.php?id=4">Complete Orders</a></li>
                      <li><a href="pages/ordermanager.php?id=6">Complete Orders Without Paid</a></li> 
                      <li><a href="pages/ordermanager.php?id=5">Rejected Orders</a></li> 
		  ...
		  <li class=""> 
		  <a class="nav-link text-left"  role="button" href="pages/customer.php">
       <i class="flaticon-bar-chart-1"></i>  Customers 
         </a>
		  </li>
		 <li class=""> 
		  <a class="nav-link text-left"  role="button" href="pages/account.php" >
       <i class="flaticon-bar-chart-1"></i> Account Manager 
         </a>
		  </li>

      <li class=""> 
      <a class="nav-link text-left"  role="button" href="pages/massage.php" >
      ...
      <li class="sidebar-header">
          ...
          <li class=""> 
      <a class="nav-link text-left"  role="button" href="pages/addcategories.php">
    ...
    <div class="container-fluid ">
              <div class="row">
                <div class="col-lg-12 px-2">
                  <div class="submenu-box"> 
                    <ul class="list-unstyled m-0">
                      <li><a href="pages/addfoods.php">Add Food Item</a></li>
                      <li><a href="pages/viewfooditem.php">View Food Item</a></li>
                    </ul>
                  </div>
                </div>
      ...
      <li class=""> 
        ...
        <!-- Custon website -->
		   <li class="sidebar-header">
			   ...
			   <li class=""> 
		  <a class="nav-link text-left"  role="button" href="pages/slider_manager.php">
       <i class="flaticon-bar-chart-1"></i>  Slider Manager
         </a>
		  </li>
		  
		    <li class=""> 
		  <a class="nav-link text-left"  role="button" href="pages/marketing.php">
       <i class="flaticon-bar-chart-1"></i>  Marketing Banners Manager 
         </a>
		  </li>
       <li class=""> 
      <a class="nav-link text-left"  role="button" href="pages/homepage_manager.php">
       <i class="flaticon-bar-chart-1"></i>  Website Appearance Manager
         </a>
      </li>
      <li class=""> 
      <a class="nav-link text-left"  role="button" href="pages/resturentdetailmanager.php">
    ...
    <div class="container-fluid ">
              <div class="row">
                <div class="col-lg-12 px-2">
                  <div class="submenu-box"> 
                    <ul class="list-unstyled m-0">
                      <li><a href="pages/addemployee.php">Add Employee</a></li>
                      <li><a href="pages/viewemployee.php">View Employee</a></li>
                    </ul>
                  </div>
                </div>
           ...
           <li class="nav-item dropdown">
                    ...
                    <?php   $counts++; } }?>
								...
								<div class="dropdown-menu-footer">
									<a href="pages/ordermanager.php?id=1" class="text-muted">Show all notifications</a>
								</div>
							</div>
						</li>
            <!-- Nav Item - Messages -->
            ...
            <li class="nav-item">
              <a class="nav-link " href="pages/massage.php" role="button">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-right py-0" aria-labelledby="alertsDropdown">
                  ...
                  <a class="nav-link " href="pages/admin_pass_change.php" role="button">
             ...
             <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-md dropdown-menu-right py-0" aria-labelledby="alertsDropdown">
                  ...
                  <a class="nav-link " href="pages/employee_username_change.php" role="button">
...
<div class="col-md-12">
       <div class="row">
                   <?php $count = 0;
                    $total_year = 0;
                    $viewquery = " SELECT * FROM getorder WHERE YEAR(trn_date) = YEAR(CURRENT_DATE())";
                    $viewresult = mysqli_query($con,$viewquery); 
                      
                      while($row1 = mysqli_fetch_assoc($viewresult)) { 

                        if ($row1['accept'] == 'Accepted' && $row1['shipped'] == 'Shipped' && $row1['deliver'] == 'Diliverd' && $row1['paid'] == 'Paid') { 
                          $total_year = $total_year + $row1['amount'];
                 ...
                 $count++; }?>
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">This Year Total Earnings</h5>
												<h1 class="display-5 mt-1 mb-3">Rs. <?php echo $total_year; ?></h1>
											</div>
										</div>
                  ...
                  <?php $count = 0;
                    $total = 0;
                    $viewquery = " SELECT * FROM getorder WHERE MONTH(trn_date) = MONTH(CURRENT_DATE()) AND YEAR(trn_date) = YEAR(CURRENT_DATE())";
                    $viewresult = mysqli_query($con,$viewquery); 
                 ...
                 $count++; }?>
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">This Month Total Earnings</h5>
												<h1 class="display-5 mt-1 mb-3">Rs. <?php echo $total; ?></h1>
											</div>
										</div>
                  ...
                  <?php $count = 0;
                    $sales = 0;
                    $viewquery = " SELECT * FROM getorder where paid = 'Paid'";
                    $viewresult = mysqli_query($con,$viewquery); 
                    ...
                    ?>
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												<h5 class="card-title mb-4">Completed Sales</h5>
												<h1 class="display-5 mt-1 mb-3"><?php echo $sales; ?></h1>
											</div>
										</div>
									...
									<div class="col-sm-3">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="display-5 mt-1 mb-3">Rs. <?php echo $full_total; ?></h1>
											</div>
										</div>
               ...
               <?php $count = 0;
                    $sales = 0;
                    $viewquery = " SELECT * FROM getorder where accept = 'Accepted' AND shipped='Pending'";
                    $viewresult = mysqli_query($con,$viewquery); 
                    $ongoingOrder = mysqli_num_rows($viewresult);
                    ?>

                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <h5 class="card-title mb-4">On Going Orders</h5>
                        <h1 class="display-5 mt-1 mb-3"><?php echo $ongoingOrder; ?></h1>
                      </div>
                    </div>
                  ...
                  <?php $count = 0;
                    $sales = 0;
                    $viewquery = " SELECT * FROM food_items";
                    $viewresult = mysqli_query($con,$viewquery); 
                  ...
                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <h5 class="card-title mb-4">Listed Food Items</h5>
                        <h1 class="display-5 mt-1 mb-3"><?php echo $reject; ?></h1>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <h5 class="card-title mb-4">Customer Base</h5>
                        <h1 class="display-5 mt-1 mb-3"><?php echo $customers; ?></h1>
                      </div>
                    </div>
                  ...
                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <h5 class="card-title mb-4">Shop Opening</h5>
                        <h1 class="display-5 mt-1 mb-3"><?php echo $row1['rest_opening']; ?></h1>
                        <a class="text-danger" href="shopstate.php">Change Shop State</a>
                      </div>
                    </div>
