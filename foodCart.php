...
<div class="row">
	...
	<!-- Start Cart -->
		<?php 
		$carts="SELECT * FROM cart where email='".$getEmail."'";
		...
		$id = $row['food_id'];
			...
			$food="SELECT * FROM food_items where food_id='".$id."'";
			...
			<div class="row mt-5 mb-5">
				...
				<div class="col-md-3">
					<img style="width: 100%;" class="img-fluid" src="<?php echo $foodimage_src; ?>"  alt="Gallery Images">
				</div>
				...
				<div class="col-md-2 p-5">
					<a href="pages/delete.php?cart_id=<?php echo $row1['food_id']; ?>"><h4><i style="font-size: 30px" class="fas fa-times"></i></h4></a>
				</div>
			</div>
<?php }  }?>
		</div>
		<?php $carts="SELECT * FROM cart where email='".$getEmail."'";
		$carts1 = mysqli_query($con,$carts); 
		if ($row = mysqli_fetch_assoc($carts1)) {  ?>
		<div class="col-md-4 mt-5 p-5" style="background-color: #f9f6f7; padding-left: 5%;">
			<h1 style="color: green">Food Summery</h1><br>
            ...
            <div class="col-sm-4">
              ...
              <p>Rs. <?php echo $total + $diliverFee; ?> </p>
            </div>
