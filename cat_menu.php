...
if(mysqli_num_rows($slider_query_result)>0){
 ...
 ?>
	...
	<?php $id = $_REQUEST['cat_name'];
	$cat="SELECT * FROM category where cat_id='$id'";
	$query_cat = mysqli_query($con,$cat); 
	$row1 = mysqli_fetch_assoc($query_cat);
		?>
			...
			<div class="row">
				<div class="col-lg-12">
					<!-- <div class="heading-title text-center"> -->
						<h2 style="font-size: 50px; text-align: center; color: maroon">~~~ <?php echo $row1['cat_name']; ?> ~~~</h2>
						<hr>
						<h2 style="font-size: 50px; text-align: center; color: maroon">~~~ <?php echo $row1['cat_name']; ?> ~~~</h2>
					<!-- </div> -->
				</div>
