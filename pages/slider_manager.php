...
<div class="col-md-12">
       <div class="row">
                  ...
                  <div class="col-md-8">
                            <a href="slider_manager.php"><h1 class="text-success"> Slider Manager </h1></a><br>
                            <h4 class="form_title"> Slider Banner size is 1080 X 900</h4><br><br>

                            <button type="submit" onclick="window.location.href='image_upload.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Add Slider</button><br><br>

                            <button type="submit" onclick="window.location.href='chage_image_slider.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px;float:left;">Edit Slider Images</button><br><br>

                            <button type="submit" onclick="window.location.href='remove_image.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Remove Slider</button>
