          ...
          <form class="col-md-10 ml-5" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <br>
                      ...
                      <div class="form-group col-md-6">
                        <label for="title" class="a"><b>About Title</b></label>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="desc" class="a"><b>About Description</b></label>
                        <input type="text" class="form-control" name="desc" placeholder="About Description">
                      </div>
                    </div>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   if(isset($_POST['submit'])){
                      ...
                      if( in_array($imageFileType,$extensions_arr) ){
                          ...
                          echo '<script>alert("Update is Success"); window.location.href="about_manager.php";</script>';
                      }
                      ...
                      if(!empty($title))
                      {
                        ...
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"about_manager.php\";</script>";
                      }
                      if(!empty($desc))
                      {
