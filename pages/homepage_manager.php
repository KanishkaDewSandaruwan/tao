...
<div class="col-md-12">
       <div class="row">
                  ...
                  <div class="col-md-8">
                            <a href="homepage_manager.php"><h1 class="text-success"> Web Site Appearance Manager </h1></a><br>
                            <!-- <h4 class="form_title"> Slider Banner size is 1080 X 900</h4><br><br> -->

                            <button type="submit" onclick="window.location.href='homepage_change.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Change Home page Details</button><br><br>

                            <button type="submit" onclick="window.location.href='galary.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px;float:left;">Manage Galary</button><br><br>

                            <button type="submit" onclick="window.location.href='lrmanager.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Login & Regisration Manager</button><br><br>
                            <button type="submit" onclick="window.location.href='about_manager.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">About Page Manager</button>
