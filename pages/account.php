...
<div class="col-md-12">
       <div class="row">
          <div class="col-md-8">
              <h1 class="text-info"> Accounts Details </h1><br>
              <?php $count = 0;
                    $total = 0;
                 ...
                 $count++; }?>
                  ...
                  <h4 class="text-success"> This Month Total Income : <?php echo $total; ?></h4><br>
                  <h4 class="text-success"> This Year Total Income : <?php echo $total_year; ?></h4><br>
                  <h4 class="text-success"> Total Income from Orders : <?php echo $full_total; ?></h4><br>
