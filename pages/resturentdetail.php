                  ...
                  <div class="col-md-12">
                            ...
                            <a href=""><h2 class="text-info">Edit Employee Details </h2> </br></a>
                              ...
                              <div class="form-group col-md-4">
                                <label><b>Resturant Email</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="address"><b>Resturant Address</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="phone"><b>Resturant Phone Number</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="fb"><b>Resturant Facebook Page link</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="twiter"><b>Resturant Twiter Page link</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="linkdin"><b>Resturant Linkdin Page link</b></label>
                            ...
                            <div class="form-row">
                            <div class="form-group col-md-4">
                              <label for="insta"><b>Resturant Instragram Page link</b></label>
                          ...
                          <div class="dropdown-divider"></div>
                           ...
                           <button type="button" name="submit" class="btn col-md-3 ml-5 btn-info"  onclick="window.location.href='resturentdetailmanager.php'" style="border-radius:20px;">Goto Back</button>
                          ...
                          if(isset($_POST['submit'])){
                            ...
                            $insta = $_REQUEST['insta'];
                              ...
                              if(!empty($emails))
                              {
                                $query3="UPDATE rest_details SET email='$emails'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }

                              if(!empty($address))
                              {
                                $query3="UPDATE rest_details SET rest_address='$address'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }
                              if(!empty($phone))
                              {
                                if(preg_match("/^([0]([7189])([071628])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9])([0-9]))$/", $phone)){
                                    $query3="UPDATE rest_details SET phone='$phone'";
                                    $sql3=mysqli_query($con,$query3);
                                    echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              ...
                              if(!empty($fb))
                              {
                                $query3="UPDATE rest_details SET fb='$fb'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }
                              if(!empty($twiter))
                              {
                                $query3="UPDATE rest_details SET tweeter='$twiter'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }
                              if(!empty($linkdin))
                              {
                                $query3="UPDATE rest_details SET linkdin='$linkdin'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }
                              if(!empty($insta))
                              {
                                $query3="UPDATE rest_details SET instragram='$insta'";
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"resturentdetailmanager.php\";</script>";
                              }
