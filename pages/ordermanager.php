...
<div class="col-md-12">
       ...
       if (isset($_REQUEST['id'])) {
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Pending' && $row1['shipped'] == 'Pending' && $row1['deliver'] == 'Pending') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '
                                      <h4><a class="text-danger" href="controlorder.php?accept='.$row1['order_id'].'">Accept this Order</a></h4>
                                      <h4><a class="text-danger" href="controlorder.php?acceptshiped='.$row1['order_id'].'">Accept and Shipped this Order</a></h4>
                                      <h4><a class="text-danger" href="controlorder.php?reject='.$row1['order_id'].'">Reject This Order</a></h4>';
                                 ?>
                          </div>
                ...
                <?php } else if($id==2) { ?>  
                <h1 class="ml-3">Confiremed Orders</h1>          
                <div class="row">
                <div class="col-md-12 text-left">
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Accepted' && $row1['shipped'] == 'Pending' && $row1['deliver'] == 'Pending') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '
                                      <h4><a class="text-danger" href="controlorder.php?shiped='.$row1['order_id'].'">Change to Shipped</a></h4>
                                      <h4><a class="text-danger" href="controlorder.php?rejectaccept='.$row1['order_id'].'">Reject This Order</a></h4>';
                                 ?>
                          </div>
                ...
                <?php } else if($id==3) { ?>            
                <div class="row">
                  <h1 class="ml-3">Deliverd Orders</h1>    
                <div class="col-md-12 text-left">
                 ...
                 <?php $count = 0;
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Accepted' && $row1['shipped'] == 'Shipped' && $row1['deliver'] == 'Pending') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '
                                      <h4><a class="text-danger" href="controlorder.php?paided='.$row1['order_id'].'">Complete Order</a></h4>
                                      <h4><a class="text-danger" href="controlorder.php?diliverd='.$row1['order_id'].'">Complete Order without Paid</a></h4>
                                      <h4><a class="text-danger" href="controlorder.php?rejectshiped='.$row1['order_id'].'">Reject This Order</a></h4>';
                                 ?>
                          </div>
                   ...
                   <?php } else if($id==4) { ?>            
                <div class="row">
                  <h1 class="ml-3">Completed Orders</h1>  
                <div class="col-md-12 text-left">
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Accepted' && $row1['shipped'] == 'Shipped' && $row1['deliver'] == 'Diliverd' && $row1['paid'] == 'Paid') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '
                                      <h4><a class="text-danger" href="controlorder.php?deletecomplete='.$row1['order_id'].'">Delete This Order</a></h4>';
                                 ?>
                          </div>
            ...
            <?php } else if($id==5) { ?>            
                <div class="row">
                  <h1 class="ml-3">Rejected Orders</h1>  
                <div class="col-md-12 text-left">
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Reject' || $row1['shipped'] == 'Reject' || $row1['deliver'] == 'Reject') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '
                                      <h4><a class="text-danger" href="controlorder.php?deletereject='.$row1['order_id'].'">Delete This Order</a></h4>';
                                 ?>
                          </div>
            ...
            <?php } else if($id==6) { ?>            
                <div class="row">
                  <h1 class="ml-3">Completed Orders without Paid</h1>  
                <div class="col-md-12 text-left">
                 ...
                 <?php $count = 0;
                    ...
                    <?php 
                        ...
                        if ($row1['accept'] == 'Accepted' && $row1['shipped'] == 'Shipped' && $row1['deliver'] == 'Diliverd' && $row1['paid'] == 'Pending') { ?>
                          ...
                          <div class="col-sm-6 mt-5">
                                <?php 
                                echo '<h4><a class="text-danger" href="controlorder.php?paided='.$row1['order_id'].'">Pay This Order</a></h4>';
                                echo '<h4><a class="text-danger" href="controlorder.php?deleterejectwithoutpaid='.$row1['order_id'].'">Delete This Order</a></h4>';
                                 ?>
                          </div>
