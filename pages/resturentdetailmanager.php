...
<div class="col-md-12">
       <div class="row">
                  ...
                  <div class="col-md-8">
                            <a href="resturentdetailmanager.php"><h1 class="text-success"> Resturant Details Manager </h1></a><br>
                            <!-- <h4 class="form_title"> Slider Banner size is 1080 X 900</h4><br><br> -->

                            <button type="submit" onclick="window.location.href='opencontrol.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Resturent Opening Manager</button><br><br>

                            <button type="submit" onclick="window.location.href='resturentdetail.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px;float:left;">Manage Reasturant Details</button><br><br>
