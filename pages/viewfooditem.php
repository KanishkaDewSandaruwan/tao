       ...
       <div class="container-fluid p-0 px-lg-0 px-md-0">
        ...
        <nav class="navbar navbar-expand navbar-light my-navbar">
         ...
         <span></span>
            ...
            <!-- Topbar Search -->    
          <form class="d-none d-sm-inline-block form-inline navbar-search" method="POST" action="">
            <div class="input-group">
              <input type="text" class="form-control bg-light" name="search" placeholder="Search for..." aria-label="Search">
      ...
      <div class="row">
                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <?php 
                          $query2="SELECT * FROM food_items";
                                                    $sql2=mysqli_query($con,$query2);
                                                    $number = mysqli_num_rows($sql2);
                         ?>
                        <h5 class="card-title mb-4">Number of Foods</h5>
                  ...
                  <div class="col-sm-3">
                    <div class="card">
                      <div class="card-body">
                        <?php 
                          $query2="SELECT * FROM food_items where available='Yes'";
                                                    $sql2=mysqli_query($con,$query2);
                                                    $number = mysqli_num_rows($sql2);
                         ?>
                        <h5 class="card-title mb-4">Available Foods</h5>
                        <h1 class="display-5 mt-1 mb-3 ml-3"><?php echo $number; ?></h1>
                        <div class="mb-1">
                        </div>
                      </div>
                      ...
                      <div class="card-body">
                        <?php 
                          $query2="SELECT * FROM category";
                                                    ...
                                                    $number = mysqli_num_rows($sql2);
                         ?>
                        <h5 class="card-title mb-4">Number of Category</h5>
                        <h1 class="display-5 mt-1 mb-3 ml-3"><?php echo $number; ?></h1>
                        <div class="mb-1">
                        </div>
                      </div>
...
<div class="col-md-12 mt-lg-4 mt-4">
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <a href=""><h1 class="h3 mb-0 text-danger">Food Item List</h1></a>
          </div>
      </div>
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-dark">
                                            <th class="border-top-0 text-white">Food Code</th>
                                            <th class="border-top-0 text-white">Category</th>
                                            <th class="border-top-0 text-white">Food Name</th>
                                            ...
                                            <th class="border-top-0 text-white">Edit Details</th>
                                            <th class="border-top-0 text-white">Remove Employee</th>
                                        </tr>
                                    </thead>
                                    <?php 
                                    ...
                                    if (isset($_POST['submit'])) {
                                      ...
                                      if (!empty($search)) {
                                        $count=1;
                                        $viewquery = " SELECT * FROM food_items where food_id='".$search."' OR food_name LIKE '%$search%'";
                    									  $viewresult = mysqli_query($con,$viewquery);
                                      }else{
                                        echo "<script type=\"text/javascript\"> alert(\"Enter Keyword to Search\"); window.location= \"viewfooditem.php\";</script>";
                                      }
                                    }else{
                                      $count=1;
                                        ...
                                        <tbody>
                                            ...
                                            $viewquery1 = " SELECT * FROM category where cat_id='".$row['food_cat_id']."'";
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <h4 class="m-b-0 font-16"><?php echo $row['food_id']; ?></h4>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td><?php echo $row1['cat_name']; ?></td>
                                                <td>
                                                    <label class="label label-danger"><?php echo $row['food_name']; ?></label>
                                                </td>
                                                ...
                                                <td><h5 class="m-b-0"><?php echo $row['available']; ?></h5></td>
                                                <td><?php echo $row['trndate']; ?></td>
                                                <td><a style="text-decoration: none; color: red; font-size: 15px;" href="edit.php?quick_food_id=<?php echo $row['food_id']; ?>">Quick Edit</a></td>
                                                <td><a style="text-decoration: none; color: red; font-size: 15px;" href="edit.php?food_id=<?php echo $row['food_id']; ?>">Edit</a></td>
                                                <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?food_id=<?php echo $row['food_id']; ?>">Delete</a></td>
                                            </tr>
                                            <?php   $count++;  }?>
                                    </tbody>
                                </table>
