...
<div class="col-md-12">
       <div class="row">
						<?php if (isset($_REQUEST['food_id'])){ 
                $id = $_REQUEST['food_id'];
              ?>
              
                <form class="col-md-10 ml-5" action="edit.php?food_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                      <a href=""><h2 class="text-info">Edit Food Items </h2> </br></a>
                                    <div class="form-row">
                                      <div class="form-group col-md-6">
                                        <label for="title" class="a"><b>Food Title</b></label>
                                    ...
                                    <div class="form-group col-md-6">
                                      ...
                                      <div class="form-row">
                                      <div class="form-group col-md-6">
                                        <label for="inputState"><b>Food Categories</b></label>
                                    ...
                                    <br>
                                    Select Foods Item Front image to upload:<br>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-info" style="border-radius:20px;">Save Food</button><br><br>
                   <button type="button" name="submit" onclick="window.location.href='viewfooditem.php'" class="btn col-xl-10 btn-success" style="border-radius:20px;">Back toFood List</button>
                   </div>
                   </div>
               ...
               <?php if(isset($_POST['submit'])){
                    ...
                    if( in_array($imageFileType,$extensions_arr) ){
                        ...
                        $query="UPDATE food_items SET image='$name' where food_id='".$id."'";
                        mysqli_query($con,$query);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewfooditem.php\";</script>";
                    }
                      ...
                      if(!empty($title))
                      {
                        ...
                        $query3="UPDATE food_items SET food_name='$title' WHERE food_id='".$id."'";
                       ...
                       if(!empty($desc))
                      {
                        $query3="UPDATE food_items SET description='$desc' WHERE food_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewfooditem.php\";</script>";
                      }
                      ...
                      if(!empty($cat))
                      {
                        if ($row2['cat_id']) {
                          ...
                          $query3="UPDATE food_items SET food_cat_id='$cat_id' WHERE food_id='".$id."'";
                          $sql3=mysqli_query($con,$query3);
                          echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewfooditem.php\";</script>";
                        }
                      }
                      ...
                      if(!empty($price))
                      {
                        $query3="UPDATE food_items SET price='$price' WHERE food_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewfooditem.php\";</script>";
                      }
                      ...
                      if(!empty($available))
                      {
                        $query3="UPDATE food_items SET available='$available' WHERE food_id='".$id."'";
                        $sql3=mysqli_query($con,$query3);
                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewfooditem.php\";</script>";
                      }
             ...
             }else if (isset($_REQUEST['quick_food_id'])){ 
                $id = $_REQUEST['quick_food_id'];
              ?>
              
                <form class="col-md-10 ml-5" action="edit.php?quick_food_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                      <a href=""><h2 class="text-info">Quick Edit Food Items </h2> </br></a>
                    ...
                    $res2 = mysqli_query($con,$q2);
                      ...
                      if($id==$row1['emp_id'])
                       { ?>
                        ...
                        <form class="col-md-10 ml-5" action="edit.php?emp_id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                            <a href=""><h2 class="text-info">Edit Employee Details </h2> </br></a>
                            <div class="form-row">
                          ...
                          <div class="dropdown-divider"></div>
                           ...
                           <button type="button" name="submit" class="btn col-md-3 ml-5 btn-info"  onclick="window.location.href='viewemployee.php'" style="border-radius:20px;">Goto Back</button>
                            ...
                            if(!empty($fname))
                              {
                                ...
                                $sql3=mysqli_query($con,$query3);
                                echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location= \"viewemployee.php\";</script>";
                              }
                              if(!empty($emails))
                              {
                                  ...
                                  $sql1=mysqli_query($con,$query1);
                                    ...
                                    if(mysqli_num_rows($sql1)>0)
                                    {
                                    ...
                                    else
                                      {
                                        ...
                                        $sql3=mysqli_query($con,$query3);
                                        echo "<script type=\"text/javascript\"> alert(\"Updated Succussfully\"); window.location.href='viewemployee.php';</script>";
                                      }
                                }
                              }
                              if(!empty($address))
