...
<div class="col-md-8">
       <div class="row">
          ...
          <form class="col-md-10 ml-5" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="container-fluid">
    <div class="row">
        <div class="col-md-4 mt-5 col-md-5 text-center">
              <div class="form-login"></br>
                <form action="" method="POST"> 
                    <h2>Change Username</h2>
                    </br>
                    <input type="text" name="uname" id="userPassword" class="form-control input-sm chat-input" placeholder="New Username"/>
                    </br></br>
                    <div class="wrapper">
                        <button style="font-size: 20px; padding-bottom: 7%;" class="btn col-md-12 input-md btn-info" type="submit" name="submit">Change Usename</button><br><br>
                    </div>
                </form>
            </div>
        </div>
