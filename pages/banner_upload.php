...
<div class="col-md-12">
  ...
  if(mysqli_num_rows($viewresult)>0){
      echo '<script>alert("Slide Show Alrady Addedd. You can Only Change Image"); window.location.href="marketing.php";</script>';
  }else{
      ...
      if( in_array($imageFileType,$extensions_arr) ){
                 ...
                 move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name);
                  ...
                  echo '<script>alert("Slide Show Inserted Success"); window.location.href="marketing.php";</script>';
