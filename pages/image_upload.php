...
<div class="col-md-12">
       <div class="row">
                  ...
                  <form method="post" action="" style="padding: 3%;" enctype='multipart/form-data'>
                    ...
                    <input class="btn btn-dark col-sm-5" type='submit' value='Upload' name='but_upload'><br><br>

                    <button type="button" onclick="window.location.href='slider_manager.php'" name="button" class="btn col-xl-10 btn-dark">Back to Slide Manager</button><br><br>
                  </form>
                  ...
                  <?php
                   if(isset($_POST['but_upload'])){
                    ...
                    if(mysqli_num_rows($viewresult)>0){
                        echo '<script>alert("Slide Show Alrady Addedd. You can Only Change Image"); window.location.href="slider_manager.php";</script>';
                    }else{
                            ...
                            if( in_array($imageFileType2,$extensions_arr) ){
                                if (!empty($title)) {
                                   ...
                                   move_uploaded_file($_FILES['file2']['tmp_name'],$target_dir.$name2);
                                    ...
                                    echo '<script>alert("Slide Show Inserted Success"); window.location.href="slider_manager.php";</script>';
