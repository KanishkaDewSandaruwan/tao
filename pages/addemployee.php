...
<div class="col-md-12">
       <div class="row">
						<form class="col-md-10 ml-5" action="" method="POST">
                    <h2 class="text-info">Register Employes </h2> </br>
                    <div class="form-row">
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-info" style="border-radius:20px;">Save Employee</button>
                   </div>
                   </div>
                                    <?php
                                                                                    ...
                                                                                    echo "<script>alert(\"Email already Exsisted\");</script>";
                                                                                      ...
                                                                                      $q1="INSERT INTO employee(full_name,address,phone_number,email,gender,password,username,trndate) values('$fname','$address','$phone','$emails','$gender','".md5($pass)."','$uname','$cdate')";
                                                                                            ...
                                                                                            if ( $res1) {
                                                                                                 ...
                                                                                                 echo '<script>alert("Employee Registration is Scussessfully.");
