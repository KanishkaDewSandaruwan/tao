...
<div class="col-md-8">
       <div class="row">
          ...
          <form class="col-md-10 ml-5" action="" method="POST" enctype="multipart/form-data">
                    <h2 class="text-info">Add Galary Images</h2> </br>
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-info" style="border-radius:20px;">Add to Galary</button>
                   </div>
                   </div>
                                    <?php
                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                        ...
                                        $image_src = "../upload/galary/".$image;
                                        ?>
                                        <tr>
                                            <td><img width="100px" src='<?php echo $image_src; ?>'></td>
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?image_id=<?php echo $row['image_id']; ?>">Delete</a></td>
                                        </tr>
                                        <?php   $count++;  }?>
                                    </tbody>
                                </table>
