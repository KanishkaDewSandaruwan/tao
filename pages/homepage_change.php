...
<div class="col-md-12">
       <div class="row">
                  ...
                  <form method="post" action="" style="padding: 3%;" enctype='multipart/form-data'>
                    ...
                    <p style="font-size: 20px; color: green">Background Image</p>
                    <input type='file' name='file' /><br><br>

                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="name" class="a"><b>Image Background Description</b></label>
                        <input type="text" class="form-control" name="image_back_desc" placeholder="Image Background Description">
                      </div>
                    </div><br><br><br>

                    <p style="font-size: 20px; color: green">Second Block Image</p>
                    <input type='file' name='file1' /><br><br>

                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="name" class="a"><b>Second Block Title</b></label>
                        <input type="text" class="form-control" name="second_title" placeholder="Second Block Title">
                      </div>
                    </div>
                    ...
                    <input class="btn btn-dark col-sm-5" type='submit' value='Change' name='but_upload'><br><br>

                    <button type="button" onclick="window.location.href='homepage_manager.php'" name="button" class="btn col-xl-10 btn-dark">Back to Home Page Manager</button><br><br>
                  </form>

                  <?php
                   if(isset($_POST['but_upload'])){

                    $image_back_desc = $_REQUEST['image_back_desc'];
                    $second_title = $_REQUEST['second_title'];
                    $desc = $_REQUEST['desc'];
                      ...
                      if( in_array($imageFileType,$extensions_arr) ){
                          ...
                          $query="UPDATE home_images SET background_image='$name'";
                          mysqli_query($con,$query);
                          echo '<script>alert("Update is Success"); window.location.href="homepage_manager.php";</script>';
                      }
                      if( in_array($imageFileType1,$extensions_arr) ){
                          move_uploaded_file($_FILES['file1']['tmp_name'],$target_dir.$name1);   
                          $query="UPDATE home_images SET second_block_image='$name1'";
                          mysqli_query($con,$query);
                          echo '<script>alert("Update is Success"); window.location.href="homepage_manager.php";</script>';
                      }

                      if(!empty($image_back_desc))
                      {

                        $query3="UPDATE home_images SET second_block_image_description='$image_back_desc'";
                      ...
                      if(!empty($second_title))
                      {
                        ...
                        $query3="UPDATE home_images SET second_block_title='$second_title'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Update is Success"); window.location.href="homepage_manager.php";</script>';
                      }
                      if(!empty($desc))
                      {
                        ...
                        $query3="UPDATE home_images SET secomd_block_description='$desc'";
                        $sql3=mysqli_query($con,$query3);
                          echo '<script>alert("Update is Success"); window.location.href="homepage_manager.php";</script>';
                      }
