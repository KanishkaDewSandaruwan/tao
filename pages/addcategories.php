...
<div class="col-md-8">
       <div class="row">
                    ...
                    <h2 class="text-info">Add Food Category</h2> </br>
                    <div class="form-row">
                  ...
                  <div class="dropdown-divider"></div>
                   ...
                   <button type="submit" name="submit" class="btn col-xl-10 btn-info" style="border-radius:20px;">Save Food Category</button>
                   </div>
                   </div>
                                    <?php
                                                    ...
                                                    if (in_array($imageFileType,$extensions_arr)) {
                                                            ...
                                                            $q1="INSERT INTO category(cat_name,cat_image) values('$cat_name','$name')";
                                                                  ...
                                                                  if ( $res1)
                                                                  {
                                                                       ...
                                                                       echo '<script>alert("Food Category Save is Scussessfully.");window.location.href="addcategories.php"; </script>';
                                                                  }else{
                                                                    echo "<script>alert(\"Food Categori Save is Not Scussess\");</script>";
                                                                  }
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-dark">
                                            <th class="border-top-0 text-white">Category Name</th>
                                    ...
                                    <tbody>
                                      <?php while($row = mysqli_fetch_assoc($viewresult)) { 
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="edit.php?cat_id=<?php echo $row['cat_id']; ?>">Edit</a></td>
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?cat_id=<?php echo $row['cat_id']; ?>">Delete</a></td>
                                        </tr>
                                        <?php   $count++;  }?>
                                    </tbody>
                                </table>
