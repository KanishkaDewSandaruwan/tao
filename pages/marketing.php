...
<div class="col-md-12">
       <div class="row">
                  ...
                  <div class="col-md-8">
                            <h1 class="text-info"> Promotion Banner Manager </h1><br>
                            <h4 class="form_title"> Promotion Banner size is 1080 X 900</h4>

                            <button type="submit" onclick="window.location.href='banner_upload.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Add Banner</button><br><br>

                            <button type="submit" onclick="window.location.href='change_banner_image.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px;float:left;">Change Banner Images</button><br><br>

                            <button type="submit" onclick="window.location.href='remove_banner.php'" name="button" class="btn col-xl-4 btn-dark" style="border-radius:20px; float:left;">Remove Banner</button>
