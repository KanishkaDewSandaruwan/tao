                    ...
                    <h2 class="text-info">Add Food Category</h2> </br>
                     <div class="form-row">
                                        <div class="form-group col-md-6">
                                          <label for="inputState"><b>Resturant Opening</b></label>
                                          <select id="inputState" name="open" class="form-control">
                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-dark">
                                            <th class="border-top-0 text-white">Shop Opening</th>
                                        </tr>
                                    </thead>
                                    <?php 
                                    $count=1;
                                    ...
                                    $viewresult = mysqli_query($con,$viewquery);
                                     ...
                                     ?>
                                    <tbody>
                                      <?php if($row = mysqli_fetch_assoc($viewresult)) { ?>
                                        <tr>
                                            <td><?php echo $row['rest_opening']; ?></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
                                </table>
