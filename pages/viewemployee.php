...
<div class="col-md-12">
       <div class="row">
                            ...
                            $number = mysqli_num_rows($sql2);
												 ?>
												<h5 class="card-title mb-4">All Empoyees</h5>
												<h1 class="display-5 mt-1 mb-3 ml-3"><?php echo $number-1; ?></h1>
												<div class="mb-1">
												</div>
											</div>
										</div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="m-r-10"><a class="btn btn-circle btn-info text-white"><?php echo $row['emp_id']; ?></a></div>
                                                    <div class="">
                                                        <h4 class="m-b-0 font-16"><?php echo $row['full_name']; ?></h4>
                                                    </div>
                                                </div>
                                            </td>
                                            <td><?php echo $row['address']; ?></td>
                                            <td>
                                                <label class="label label-danger"><?php echo $row['phone_number']; ?></label>
                                            </td>
                                            <td><?php echo $row['email']; ?></td>
                                            <td><?php echo $row['gender']; ?></td>
                                            <td>
                                                <h5 class="m-b-0"><?php echo $row['username']; ?></h5>
                                            </td>
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="edit.php?emp_id=<?php echo $row['emp_id']; ?>">Edit</a></td>
                                            <td><a style="text-decoration: none; color: red; font-size: 15px;" href="delete.php?emp_id=<?php echo $row['emp_id']; ?>">Delete</a></td>
                                        </tr>
                                        <?php   $count++; } }?>
                                    </tbody>
                                </table>
