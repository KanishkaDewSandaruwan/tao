			...
			<div class="tz-gallery">
				<div class="row">
					<?php 
						...
						$food="SELECT * FROM food_items where food_name LIKE '%$search%'";
						$query2 = mysqli_query($con,$food);
					...
					<?php  } 
						...
						echo '<script>alert("No Search Result found"); window.location.href="index.php"; </script>';
					 }?>
				</div>
			</div>
		</div>
